...
function start()
{
	...
	document.getElementById("umie").innerHTML='<h2 id="umiejetnosci">Umiejętności</h2><ul><li>Znajomość języków HTML5 i CSS3</li><li>Podstawowa znajomość języków JavaScript, SQL, środowiska Mathematica</li><li>Podstawowa znajomość obsługi programu AutoCAD</li><li>Bardzo dobra znajmość języka angielskiego w mowie i w piśmie</li><li>Podstawowa znajomość języka niemieckiego w mowie i w piśmie</li><li>Znajomość pakietu MS Office</li></ul>';
